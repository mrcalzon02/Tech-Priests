...
**Declarative graph:** **26 declarative active hardeners** and **37 retired source-only authorities**.
...
flowchart TD
    ...
    Planning --> Retired[37 retired authorities]
