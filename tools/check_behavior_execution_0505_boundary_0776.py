...
REQUIRED = {
    ...
    "planning": ('retired_authority_count=46', '["scripts.core.behavior_execution_doctrine_0505"]'),
    "architecture": ('scripts.core.behavior_execution_doctrine_0505', 'retired_authority_count=46'),
    ...
    "recovery": ('26-active / 46-retired graph', 'behavior-execution wrapper'),
    "history": ('26 active hardeners and 46 explicitly retired source-only authorities', 'Retired `0505` behavior-execution wrapper'),
    "testing": ('26 active hardeners and 46 retired source-only authorities', '`0505` is inert'),
    "continuity": ('46 source-preserved authorities', '`behavior_execution_doctrine_0505.lua`'),
    "map": ('46 retired source-only authorities', '`0505` is retired'),
}
FORBIDDEN = {
