...
REQUIRED = {
    ...
    "planning": ('retired_authority_count=45', '["scripts.core.behavior_execution_doctrine_0505"]'),
    "architecture": ('scripts.core.behavior_execution_doctrine_0505', 'retired_authority_count=45'),
    ...
    "recovery": ('26-active / 45-retired graph', 'behavior-execution wrapper'),
    "history": ('26 active hardeners and 45 explicitly retired source-only authorities', 'Retired `0505` behavior-execution wrapper'),
    "testing": ('26 active hardeners and 45 retired source-only authorities', '`0505` is inert'),
    "continuity": ('45 source-preserved authorities', '`behavior_execution_doctrine_0505.lua`'),
    "map": ('45 retired source-only authorities', '`0505` is retired'),
}
FORBIDDEN = {
