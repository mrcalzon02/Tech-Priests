...
REQUIRED = {
    ...
    "planning": ('retired_authority_count=47', '["scripts.core.behavior_execution_doctrine_0505"]'),
    "architecture": ('scripts.core.behavior_execution_doctrine_0505', 'retired_authority_count=47'),
