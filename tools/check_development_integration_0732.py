...
def check(project: pathlib.Path) -> int:
    ...
    require(planning, ("active_hardener_count=26", "retired_authority_count=46", 'fluid={"scripts.core.fluid_network_doctrine_0689","scripts.core.fluid_connection_planner_0691"}', "runtime_tick_broker_0600:central-pulse", "install must return literal true"), str(planning_path.relative_to(mod_root)), errors)
