...
EXPECTED_RETIRED = {
    ...
    "scripts.core.machine_logistics_final_authority_0684", "scripts.core.movement_cadence_contract_0518", "scripts.core.combat_magos_movement_authority_0472", "scripts.core.movement_bounds_contract_0511", "scripts.core.movement_enforcement_0566", "scripts.core.fluid_output_sink_doctrine_0694",
...
def main() -> int:
    ...
    need("map", texts["map"], ("26 declarative active hardeners", "Thirty-three files remain", "standard_fluid_route_discovery_0691", "fluid_turret_route_discovery_0719", "## Stage 5 — Evidence and Release Boundary"), errors)
    need("continuity", texts["continuity"], ("26 retained hardeners", "33 source-preserved authorities", "## Standard-fluid authority", "## Fluid-turret authority"), errors)
    need("history", texts["history"], ("26 active hardeners and 33 explicitly retired", "Consolidated standard-fluid authority", "No accepted Factorio runtime logs have yet been recorded"), errors)
    ...
    print("Recovery architecture observations: active=26 retired=33 construction=canonical standard_fluid=consolidated fluid_turret=consolidated")
    if errors:
