...
def main() -> int:
    ...
    need("map", texts["map"], ("26 declarative active hardeners", "Thirty-five files remain", "standard_fluid_route_discovery_0691", "fluid_turret_route_discovery_0719", "## Stage 5 — Evidence and Release Boundary"), errors)
    need("continuity", texts["continuity"], ("26 retained hardeners", "35 source-preserved authorities", "## Standard-fluid authority", "## Fluid-turret authority"), errors)
    need("history", texts["history"], ("26 active hardeners and 35 explicitly retired", "Consolidated standard-fluid authority", "No accepted Factorio runtime logs have yet been recorded"), errors)
    ...
    print("Recovery architecture observations: active=26 retired=35 construction=canonical standard_fluid=consolidated fluid_turret=consolidated")
    if errors:
