#!/usr/bin/env python3
"""Validate direct 0302/0305 ownership and retired generated equipment layers."""
...
REQ={
 ...
 "part20":('TECH_PRIESTS_0302_ENSURE_WRAPPER_RETIRED = true','TECH_PRIESTS_0305_ENSURE_WRAPPER_RETIRED = true','TECH_PRIESTS_0302_DEBUG_COMMAND_RETIRED = true','TECH_PRIESTS_0305_DEBUG_COMMAND_RETIRED = true','TECH_PRIESTS_0306_REFRESH_OVERRIDE_RETIRED = true','TECH_PRIESTS_0306_DEBUG_COMMAND_RETIRED = true','TechPriestsRuntimeEventRegistry.on_nth_tick(887','TechPriestsRuntimeEventRegistry.on_nth_tick(83','TECH_PRIESTS_PRE_SUB_EQUIPMENT_DAMAGE_0305 = tech_priests_0302_mitigate_damage','"visible-grid"','"station-inventory-compatibility"'),
 "part21":('TECH_PRIESTS_0306_REFRESH_OVERRIDE_RETIRED = true','TECH_PRIESTS_0306_DEBUG_COMMAND_RETIRED = true','visible-grid reading is consolidated into canonical 0305'),
...
FORBID={
 ...
 "part21":('function tech_priests_0305_refresh_pair_equipment(pair, reason)','TECH_PRIESTS_PRE_GRID_REFRESH_0306 = tech_priests_0305_refresh_pair_equipment','TechPriestsDebugCommandRegistry.add("tp-grid-0306"')}
...
def main():
 ...
 count_contract(texts['part20'],'function tech_priests_0305_refresh_pair_equipment(pair, reason)',1,'canonical 0305 equipment reader',errors)
 count_contract(texts['part21'],'function tech_priests_0305_refresh_pair_equipment(pair, reason)',0,'retired 0306 refresh replacement',errors)
 if errors:
  print('0302/0305/0306 equipment ownership audit failed:',file=sys.stderr)
  for e in errors:print('  - '+e,file=sys.stderr)
  return 1
 print('0302/0305/0306 equipment ownership audit passed: canonical creation/recovery, one reader, one damage chain, and one periodic chain own equipment state; 0306 is presentation-only and generated equipment commands are retired.')
 return 0
