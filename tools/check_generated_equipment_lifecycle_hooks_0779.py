...
FORBID={
 ...
 "part21":('TECH_PRIESTS_PRE_GRID_REFRESH_0306 = tech_priests_0305_refresh_pair_equipment','TechPriestsDebugCommandRegistry.add("tp-grid-0306"')}
...
def main():
 ...
 if errors:
  ...
  return 1
 print('0302/0305 lifecycle hook audit passed: canonical creation/recovery and one ordered damage/periodic chain own equipment state; 0306 refresh replacement and legacy commands are retired.')
 return 0
