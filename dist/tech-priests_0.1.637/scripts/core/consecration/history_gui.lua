...
function M.open_for_player(player, entity)
  ...
  -- 0.1.636: safe layout fallback. The ornate sliced shell is visually rich but
  ...
  local tabs = ledger_parent.add{ type = "tabbed-pane", name = "tech_priests_machine_spirit_tabs_0526" }
