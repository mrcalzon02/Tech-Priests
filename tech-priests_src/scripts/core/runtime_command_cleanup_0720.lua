...
local KNOWN_COMMANDS = {
  ...
  ["tp-cog-summary"] = true,
  ["tp-force-emergency"] = true,
  ["tp-emergency-status"] = true,
  ["tp-write-emergency-log"] = true,
  ["tp-survival-status"] = true,
  ["tp-bootstrap-now"] = true,
  ["tp-fast-debug-status"] = true,
  ["tp-raw-fallback-debug"] = true,
  ["tp-refresh-orders"] = true,
  ["tp-no-resources-debug"] = true,
  ["tp-subordinates-debug"] = true,
  ["tp-direct-gather-debug"] = true,
  ["tp-replan-gather"] = true,
  ["tp-scheduler-0277"] = true,
  ["tp-radar-0278"] = true,
  ["tp-radar-0281"] = true,
  ["tp-radar-0282"] = true,
  ["tp-radar-0283"] = true,
  ["tp-fanout-0284"] = true,
  ["tp-scheduler-0285"] = true,
  ["tp-scheduler-0286"] = true,
  ["tp-acquire-0287"] = true,
  ["tp-craft-0290"] = true,
  ["tp-ground-0291"] = true,
  ["tp-combat-0292"] = true,
  ["tp-combat-0293"] = true,
  ["tp-retreat-0294"] = true,
  ["tp-swarm-0295"] = true,
  ["tp-supply-0296"] = true,
  ["tp-armor-0297"] = true,
